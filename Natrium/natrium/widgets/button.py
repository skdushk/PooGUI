...
class Button(widgets.Label):
    ...
    def __init__(self, container, text="", style=None, font=('gadugi', 15), anchor='topleft', size=None, padding=(10, 10),
                 click_once=True, command=lambda: None):
